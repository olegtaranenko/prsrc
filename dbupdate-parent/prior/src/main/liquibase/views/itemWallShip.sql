...
-- единым списком выводитс€ суммы по затратам и реализации заказов, которые можно рассматривать как отгруженные
-- по всем направлени€м де€тельности: производственные (издели€ и отдельна€ ном-ра), услуги, продажи.
-- используетс€ в отчете –еализаци€ “оваров
as 
select 
	  po.outdate
	, po.numorder
