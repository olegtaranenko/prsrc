...
Grid.FormatString = "|<Номер|<Описание|<Ед.измерения|Кол-во|Ф.остатки|Д.остатки"
...
'    If Not tbNomenk.NoMatch Then
    If Not tbNomenk.BOF Then
        MsgBox "Номенклатура '" & gNomNom & "' уже есть в предметах заказа!", , "Предупреждение"
        GoTo EN2
    End If
    ...
    If s < -0.005 Then 'в 2х местах
        ...
        "Подтвердите") = vbCancel Then GoTo EN2
    End If
