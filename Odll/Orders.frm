...
Dim toClos As Boolean, titl As String, StatM As String, StatO As String, zalog As Variant
...
zalog = tqOrders!zalog
If IsNull(zalog) Then
    zalog = 0
End If
...
If paid - ordered > 0.01 Then
  If problem <> Problems(5) Then 'переплата
    isConflict = True
    If msg <> "" Then MsgBox msg & " переплачен." & ukagite, , titl
  End If
  Exit Function
End If
